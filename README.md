...
[![Email](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:ceyanesb@gmail.com)
...
I'm also actively building with AI — working with Claude API, OpenAI API, and n8n to design automation workflows and AI agents.
...
![NFC](https://img.shields.io/badge/NFC-003087?style=flat-square&logo=nfc&logoColor=white)
![BLE](https://img.shields.io/badge/BLE-0082FC?style=flat-square&logo=bluetooth&logoColor=white)
![OTA Updates](https://img.shields.io/badge/OTA_Updates-000000?style=flat-square&logo=expo&logoColor=white)
...
![App Center](https://img.shields.io/badge/App_Center-CB2E6D?style=flat-square&logo=microsoft&logoColor=white)
...
![Braintree](https://img.shields.io/badge/Braintree-009CDE?style=flat-square&logo=paypal&logoColor=white)
...
- 🚀 **[carlosyanes.com](https://carlosyanes.com)** — personal portfolio with Astro + Cloudflare Pages
- 🤖 Exploring AI agent development with Claude API and OpenAI
- ⚙️ Automating workflows, Agentic AI and n8n
...
|---|---|---|
| **Firstleaf** | Sr. Software Engineer | Shopify migration, 90% load time reduction, AppsFlyer integration |
| **Standard AI** | Sole Mobile Developer | NFC payments, kiosk device control, AI vision monitoring platform |
| **La Wawa** | Tech Lead | 100K+ waitlist entries, full-stack architecture across RN, Next.js, Express |
